...
global.anitav4 = process.env.BOT_NAME || "AtomicXshadow";
global.ownername = process.env.OWNER_NAME || "shadow D atomic";
global.packname = process.env.PACK_NAME || "AtomicXshadow";
global.author = process.env.AUTHOR || "shadow D atomic";
global.channelname = process.env.CHANNEL_NAME || "shadow D atomic";
